...
if(isset($_GET['mac_id']) && isset($_GET['vg_id'])){
  $strSQL = "DELETE FROM tfc_grouping_description WHERE vg_id = '".$_GET['vg_id']."'";
  $resultDel = $db->delete($strSQL);

  $strSQL = "DELETE FROM tfc_vehicle_grouping WHERE vg_id = '".$_GET['vg_id']."'";
  $resultDel = $db->delete($strSQL);
