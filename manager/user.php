            ...
            <br>
              <div class="tab-content">
                ...
                <div class="tab-pane active" id="jscontrols">
                  ...
                  $strSQL = "SELECT * FROM tfc_useraccount a inner join tfc_userinformation b on a.username = b.username inner join tfc_usertype c on a.usertype = c.usertype_id WHERE a.license = '".$resultUserInfo[0]['license']."' $key";
                  ...
                  <div class="dataTable_wrapper">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    $strSQL = "SELECT * FROM tfc_useraccount a inner join tfc_userinformation b on a.username = b.username inner join tfc_usertype c on a.usertype = c.usertype_id WHERE a.license = '".$resultUserInfo[0]['license']."' $key2 limit $start_row, $row_per_page";
                                    ...
                                    if($resultUser){
                                      ...
                                      foreach($resultUser as $v){
                                        ...
                                        <tr <?php print $class; ?>>
                                            ...
                                            <td><a href="user_detail.php?id=2&username=<?php print $v['username'];?>"><?php print $v['username'];?></a></td>
                                            ...
                                            <?php
                                              ...
                                              if($v['userstatus']=='Yes'){
                                                ?>
                                                <button type="button" class="btn btn-success" onclick="change_user_status('<?php print $v['username'];?>','No','user.php?id=2')" style="width:80px; font-size:0.9em;" <?php if(($v['usertype']=='002') && ($v['username']==$_SESSION['userTFC'])){ print "disabled"; }?>>Actived</button>
                                                <?php
                                              }else{
                                                ?>
                                                <button type="button" class="btn btn-warning" onclick="change_user_status('<?php print $v['username'];?>','Yes','user.php?id=2')" style="width:80px; font-size:0.9em;" <?php if(($v['usertype']=='002') && ($v['username']==$_SESSION['userTFC'])){ print "disabled"; }?>>Disabled</button>
                                                <?php
                                              }
                                            ...
                                            <?php
                                              ...
                                              if($v['active_status']=='Yes'){
                                                ?>
                                                <button type="button" class="btn btn-success" onclick="change_user_active_status('<?php print $v['username'];?>','No','user.php?id=2')" style="width:80px; font-size:0.9em;" <?php if(($v['usertype']=='002') && ($v['username']==$_SESSION['userTFC'])){ print "disabled"; }?>>Actived</button>
                                                <?php
                                              }else{
                                                ?>
                                                <button type="button" class="btn btn-warning" onclick="change_user_active_status('<?php print $v['username'];?>','Yes','user.php?id=2')" style="width:80px; font-size:0.9em;" <?php if(($v['usertype']=='002') && ($v['username']==$_SESSION['userTFC'])){ print "disabled"; }?>>Disabled</button>
                                                <?php
                                              }
                                            ...
                                            <td class="center">
                                              <button type="button" class="btn btn-reverse" onclick="update_account('<?php print $v['username'];?>')"  <?php if(($v['usertype']=='002') && ($v['username']==$_SESSION['userTFC'])){ print "disabled"; }?>><i class="icon-wrench"></i></button>
                                              <button type="button" class="btn btn-danger" onclick="delete_account('<?php print $v['username'];?>','user.php?id=2')"  <?php if(($v['usertype']=='002') && ($v['username']==$_SESSION['userTFC'])){ print "disabled"; }?>><i class="icon-trash"></i></button>
                                            </td>
                                        </tr>
                                        <?php
                                        $c++;
